								...
								<table cellpadding="0" cellspacing="0">
									<tbody>
										<tr>
											<td></td>
											<td>
												<table width="100%" border="0" cellspacing="0" cellpadding="0" style="direction:ltr;padding-bottom:7px;font-family:Roboto-Regular,Helvetica,Arial,sans-serif;"><tbody><tr><td align="center" style="font-weight: bold; font-size: 16px; color: #FFF; text-transform: uppercase; text-align:center"><img src="https://www.pavastecnologia.com/img/logoPavasStay.png" style="height:50px"></td>
											...
											<div style="background-color:#f5f5f5; direction:ltr; padding:22px 16px; margin-bottom:3px">
												<table class="x_m_6542478942723271434v2rsp" width="100%" border="0" cellspacing="0" cellpadding="0">
													<tbody>
														<tr>
															<td class="x_star-rating" style="direction:ltr; text-align:center">
																<span style="font-family: Roboto-Regular, Helvetica, Arial, sans-serif, serif, EmojiFont; font-size: 14px; 		line-height: 1.6; color: rgba(0, 0, 0, 0.54); font-weight: bold;">%titulo%
																</span> 
															</td>
														</tr>
														<tr>
															<td style="direction:ltr">
																<span style="font-family: Roboto-Regular, Helvetica, Arial, sans-serif, serif, EmojiFont; font-size: 13px; line-height: 1.6; color: rgba(0, 0, 0, 0.54);">%contenido2%<br aria-hidden="true"></span>
															</td>
														</tr>
													</tbody>
												</table>
									...
									<td>
										<div style="text-align:left">
											<div style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;color:rgba(0,0,0,0.54);font-size:12px;line-height:20px;padding-top:10px">
												<div>Nota: 
													Si cree que ha recibido este mensaje por error, por favor pongase en contacto con nuestro centro de soporte tecnico en <a href="mailto:soporte@pavas.co" >soporte@pavas.co</a>
												</div>
